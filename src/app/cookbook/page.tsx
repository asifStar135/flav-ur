...
const CookBook = () => {
  ...
  return (
    <div>
      <div className="text-white p-6 rounded-lg shadow-md mb-4 xl:w-3/4 mx-auto">
        {/* Welcome Section */}
        <div className="flex justify-center gap-5 xl:justify-between flex-wrap items-center">
          <div>
            ...
            <p className="text-xl xl:text-2xl text-gray-300 my-3 text-center">
              Manage your perfect collection of{" "}
              <b className="text-yel">Unique & Tasty</b> Recipes. . .
            </p>

            {/* Stats */}
            <div className="bg-gray-800 px-4 xl:px-10 py-2 rounded-3xl xl:rounded-full mt-10">
              ...
              <div className="flex justify-around font-semibold text-2xl">
                <div className="text-center">
                  ...
                  <p className="text-base xl:text-lg text-gray-300 mt-3">
                    Total Recipes
                  </p>
                </div>
                <div className="text-center">
      ...
      <div className="w-11/12 xl:w-[85%] rounded-xl mx-auto py-6 xl:p-6 mb-10 shadow-inner border-2 border-gray-800 shadow-gray-800">
        <div className="">
          <h2 className="text-3xl text-center text-gray-200 font-semibold mb-5">
            Your
            <b className="text-yel"> Saved </b> Items
          </h2>
          <div className="overflow-x-scroll scrollbar-hidden w-full mb-10 p-3">
            <div
              className="flex xl:justify-center gap-3 xl:gap-6 text-lg "
              style={{
                width: cookbookStats.total * 50 + "px",
              }}
            >
              <Badge
                overflowCount={20}
                count={cookbookStats.total}
                className={`min-w-20 self-center rounded-xl text-lg text-center shadow shadow-yel border-yel hover:border text-dark transition-all ${
          ...
          <div>
            <div className="flex gap-4 xl:gap-12 flex-wrap justify-center">
              {recipeList?.map((recipe: any, index: number) => (
                <RecipeCard
                  key={index}
                  recipeItem={recipe}
                  cardWidth="w-[170px] xl:w-[275px]"
                />
              ))}
            </div>
            {pageNo.current == -1 ? (
